 ...
 * @author Longri
 */
public class SERVER_DatabaseRenderer implements IDatabaseRenderer, RenderCallback
{
	 ...
	 */
	public SERVER_DatabaseRenderer(MapDatabase mapDatabase, GraphicFactory graphicFactory)
	{
